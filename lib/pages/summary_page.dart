      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            const Text('🎚️ Slider', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
            Text('Wert: ${sliderValue.toInt()}'),
            const SizedBox(height: 20),
            const Text('⚙️ Einstellungen', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
